...
- civicrm_resources_add_resources('Job Contract (CiviHR)', array('gulpfile.js', 'hrjc.css', 'contact.js'));
This will load all css/js files listed in array located anywhere in extension "Job Contract (CiviHR)".

- civicrm_resources_add_resources('Job Contract (CiviHR)', array('gulpfile.js', 'contact.js', '*.css'));
This will load all css files and 2 js files listed in array located anywhere in extension "Job Contract (CiviHR)".

- civicrm_resources_add_resources('Job Contract (CiviHR)');
